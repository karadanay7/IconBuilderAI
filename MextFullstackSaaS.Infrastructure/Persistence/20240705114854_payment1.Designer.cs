...
namespace MextFullstackSaaS.Infrastructure.Persistence
{
    ...
    [Migration("20240705114854_payment1")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MextFullstackSaaS.Domain.Identity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "66a45ee4-d268-404e-b6d4-07d419bfd749",
                            CreatedByUserId = "35c16d2a-f25b-4701-9a74-ea1fb7ed6d93",
                            CreatedOn = new DateTimeOffset(new DateTime(2024, 5, 22, 13, 16, 31, 0, DateTimeKind.Unspecified), new TimeSpan(0, 3, 0, 0, 0)),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEFAaWbWFo4yBr56bUqk9P2nOHLWyQxgNI4k6i8Wtj44PXPCKx8WjCO+Jwp8xlvzkPQ==",
            ...
            modelBuilder.Entity("MextFullstackSaaS.Domain.UserPayment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MextFullstackSaaS.Domain.UserPaymentHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MextFullstackSaaS.Domain.UserPaymentHistory", b =>
                {
                    b.HasOne("MextFullstackSaaS.Domain.UserPayment", "UserPayment")
                        .WithMany("Histories")
